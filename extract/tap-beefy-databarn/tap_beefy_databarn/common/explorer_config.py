...
EXPLORER_CONFIG: dict[Chain, ExplorerConfig] = {
    ...
    Chain.AVAX: ExplorerConfig(explorer_type=ExplorerType.ETHERSCAN, url="https://api.routescan.io/v2/network/mainnet/evm/43114/etherscan/api"),
    Chain.BASE: ExplorerConfig(explorer_type=ExplorerType.ETHERSCAN, url="https://api.basescan.org/api"),
    Chain.BSC: ExplorerConfig(explorer_type=ExplorerType.ETHERSCAN, url="https://api.bscscan.com/api", request_timeout=15),
    ...
    Chain.POLYGON: ExplorerConfig(explorer_type=ExplorerType.ETHERSCAN, url="https://api.polygonscan.com/api", request_timeout=15),
